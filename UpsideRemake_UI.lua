...
local a, b = {{1, 'ModuleScript', {'MainModule'},
               {{18, 'ModuleScript', {'Creator'}}, {28, 'ModuleScript', {'Icons'}}, {47, 'ModuleScript', {'Themes'},
                                                                                     {{50, 'ModuleScript', {'Dark'}},
                                                                                      ...
                                                                                      {54, 'ModuleScript', {'FeariseHub'}},
                                                                                      {55, 'ModuleScript', {'Typewriter'}},
                                                                                      {56, 'ModuleScript', {'Dark Typewriter'}},
                                                                                      {57, 'ModuleScript', {'VSC Light High Contrast'}},
                                                                                      {58, 'ModuleScript', {'VSC Dark High Contrast'}},}},
                {19, 'ModuleScript', {'Elements'},
                 {{21, 'ModuleScript', {'Colorpicker'}}, {27, 'ModuleScript', {'Toggle'}},
                  {23, 'ModuleScript', {'Input'}}, {20, 'ModuleScript', {'Button'}},
                  {25, 'ModuleScript', {'Paragraph'}}, {22, 'ModuleScript', {'Dropdown'}},
                  {26, 'ModuleScript', {'Slider'}}, {24, 'ModuleScript', {'Keybind'}}}},
                {29, 'Folder', {'Packages'}, {{30, 'ModuleScript', {'Flipper'},
                                               {{33, 'ModuleScript', {'GroupMotor'}},
                                                {46, 'ModuleScript', {'isMotor.spec'}},
                                                {39, 'ModuleScript', {'Signal'}}, {40, 'ModuleScript', {'Signal.spec'}},
                                                ...
                                                {31, 'ModuleScript', {'BaseMotor'}}, {43, 'ModuleScript', {'Spring'}},
                                                {35, 'ModuleScript', {'Instant'}}, {37, 'ModuleScript', {'Linear'}},
                ...
                {2, 'ModuleScript', {'Acrylic'},
                 {{3, 'ModuleScript', {'AcrylicBlur'}}, {5, 'ModuleScript', {'CreateAcrylic'}},
                  {6, 'ModuleScript', {'Utils'}}, {4, 'ModuleScript', {'AcrylicPaint'}}}}, {7, 'Folder', {'Components'},
                                                                                            {{9, 'ModuleScript',
                                                                                              {'Button'}},
                                                                                             {12, 'ModuleScript',
                                                                                              {'Notification'}},
...
local aa = {
    ...
    [16] = function()
        ...
        return function(n)
            ...
            o.CloseButton = q(i.Close, UDim2.new(1, -4, 0, 4), o.Frame, function()
                p.Window:Dialog{
                    Title = 'Close',
                    Content = 'Are You Sure You Want To Close FeariseHub ?',
                    Buttons = {{
                        Title = 'Yes',
                        Callback = function()
                            p:Destroy()
    ...
    [47] = function()
        ...
        local af = {
            Names = {'Dark', 'Darker', 'Light', 'Aqua', 'Amethyst', 'Rose', 'FeariseHub', 'Typewriter', 'Dark Typewriter',
                     'VSC Light High Contrast', 'VSC Dark High Contrast'}
        }
    ...
    [54] = function()
        ...
        return {
            Name = 'FeariseHub',
            Accent = Color3.fromRGB(230, 100, 0),
            AcrylicMain = Color3.fromRGB(30, 30, 30),
            AcrylicBorder = Color3.fromRGB(180, 80, 30),
            AcrylicGradient = ColorSequence.new(Color3.fromRGB(220, 100, 0), Color3.fromRGB(160, 50, 0)),
            AcrylicNoise = 0.92,
            TitleBarLine = Color3.fromRGB(180, 70, 30),
            Tab = Color3.fromRGB(90, 90, 90),
            Element = Color3.fromRGB(220, 100, 40),
            ElementBorder = Color3.fromRGB(130, 50, 30),
            InElementBorder = Color3.fromRGB(140, 60, 40),
            ElementTransparency = 0.86,
            ToggleSlider = Color3.fromRGB(220, 100, 40),
            ToggleToggled = Color3.fromRGB(0, 0, 0),
            SliderRail = Color3.fromRGB(220, 100, 40),
            DropdownFrame = Color3.fromRGB(220, 140, 80),
            DropdownHolder = Color3.fromRGB(140, 50, 30),
            DropdownBorder = Color3.fromRGB(100, 40, 20),
            DropdownOption = Color3.fromRGB(220, 100, 40),
            Keybind = Color3.fromRGB(220, 100, 40),
            Input = Color3.fromRGB(220, 100, 40),
            InputFocused = Color3.fromRGB(30, 20, 10),
            InputIndicator = Color3.fromRGB(200, 90, 50),
            Dialog = Color3.fromRGB(140, 50, 30),
            DialogHolder = Color3.fromRGB(110, 40, 20),
            DialogHolderLine = Color3.fromRGB(100, 30, 10),
            DialogButton = Color3.fromRGB(140, 50, 30),
            DialogButtonBorder = Color3.fromRGB(180, 70, 30),
            DialogBorder = Color3.fromRGB(120, 50, 30),
            DialogInput = Color3.fromRGB(160, 70, 40),
            DialogInputLine = Color3.fromRGB(200, 140, 80),
            Text = Color3.fromRGB(250, 230, 190),
            SubText = Color3.fromRGB(190, 160, 130),
