local function CreateGuiAndBlur(Rate, OutOf)
    local kickGui = Instance.new("ScreenGui")
    kickGui.Name = "KickGui"
    kickGui.DisplayOrder = 999
    kickGui.IgnoreGuiInset = true
    kickGui.ScreenInsets = Enum.ScreenInsets.DeviceSafeInsets
    kickGui.Parent = game:GetService("CoreGui")

    local mainFrame = Instance.new("Frame")
    mainFrame.Name = "MainFrame"
    mainFrame.AnchorPoint = Vector2.new(0.5, 0.5)
    mainFrame.BackgroundColor3 = Color3.fromRGB(54, 55, 57)
    mainFrame.BorderColor3 = Color3.fromRGB(0, 0, 0)
    mainFrame.BorderSizePixel = 0
    mainFrame.Position = UDim2.fromScale(0.5, 0.5)
    mainFrame.Size = UDim2.fromScale(0.23, 0.202)

    local questionLabel = Instance.new("TextLabel")
    questionLabel.Name = "QuestionLabel"
    questionLabel.FontFace = Font.new("rbxasset://fonts/families/SourceSansPro.json")
    questionLabel.Text = "Question"
    questionLabel.TextColor3 = Color3.fromRGB(255, 255, 255)
    questionLabel.TextScaled = true
    questionLabel.TextSize = 14
    questionLabel.TextStrokeColor3 = Color3.fromRGB(255, 255, 255)
    questionLabel.TextWrapped = true
    questionLabel.AnchorPoint = Vector2.new(0.5, 0.5)
    questionLabel.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    questionLabel.BackgroundTransparency = 1
    questionLabel.BorderColor3 = Color3.fromRGB(0, 0, 0)
    questionLabel.BorderSizePixel = 0
    questionLabel.Position = UDim2.fromScale(0.499, 0.121)
    questionLabel.Size = UDim2.fromScale(0.284, 0.142)

    local uIStroke = Instance.new("UIStroke")
    uIStroke.Name = "UIStroke"
    uIStroke.Color = Color3.fromRGB(255, 255, 255)
    uIStroke.Thickness = 0.2
    uIStroke.Parent = questionLabel

    local uITextSizeConstraint = Instance.new("UITextSizeConstraint")
    uITextSizeConstraint.Name = "UITextSizeConstraint"
    uITextSizeConstraint.MaxTextSize = 45
    uITextSizeConstraint.Parent = questionLabel
    ...
    line.Position = UDim2.fromScale(0.503, 0.234)
    line.Size = UDim2.fromScale(0.943, 0.00309)

    local uIStroke1 = Instance.new("UIStroke")
    uIStroke1.Name = "UIStroke"
    uIStroke1.Color = Color3.fromRGB(255, 255, 255)
    uIStroke1.Thickness = 0.4
    uIStroke1.Parent = line
    ...
    yes.Position = UDim2.fromScale(0.266, 0.833)
    yes.Size = UDim2.fromScale(0.469, 0.154)
    ...
    textLabel.Position = UDim2.fromScale(0.5, 0.489)
    textLabel.Size = UDim2.fromScale(0.606, 0.76)

    local uITextSizeConstraint1 = Instance.new("UITextSizeConstraint")
    uITextSizeConstraint1.Name = "UITextSizeConstraint"
    uITextSizeConstraint1.MaxTextSize = 37
    ...
    uITextSizeConstraint2.Parent = yes
    ...
    no.Position = UDim2.fromScale(0.743, 0.833)
    no.Size = UDim2.fromScale(0.461, 0.154)
    ...
    textLabel1.Position = UDim2.fromScale(0.5, 0.489)
    textLabel1.Size = UDim2.fromScale(0.617, 0.76)

    local uITextSizeConstraint3 = Instance.new("UITextSizeConstraint")
    uITextSizeConstraint3.Name = "UITextSizeConstraint"
    uITextSizeConstraint3.MaxTextSize = 37
    uITextSizeConstraint3.Parent = textLabel1

    textLabel1.Parent = no

    local uITextSizeConstraint4 = Instance.new("UITextSizeConstraint")
    uITextSizeConstraint4.Name = "UITextSizeConstraint"
    uITextSizeConstraint4.MaxTextSize = 14
    uITextSizeConstraint4.Parent = no

    no.Parent = mainFrame

    local text1 = Instance.new("TextLabel")
    text1.Name = "Text1"
    text1.FontFace = Font.new("rbxasset://fonts/families/SourceSansPro.json")
    text1.Text = "Your UNC Is "..Rate.."% Success ( "..OutOf.." )"
    text1.TextColor3 = Color3.fromRGB(174, 175, 177)
    ...
    text1.Position = UDim2.fromScale(0.513, 0.4)
    text1.Size = UDim2.fromScale(0.747, 0.108)
    text1.Parent = mainFrame

    local text2 = Instance.new("TextLabel")
    text2.Name = "Text2"
    text2.FontFace = Font.new("rbxasset://fonts/families/SourceSansPro.json")
    text2.Text = "Do You Want To Continue Receiving The Script?"
    text2.TextColor3 = Color3.fromRGB(174, 175, 177)
    ...
    text2.Position = UDim2.fromScale(0.514, 0.513)
    text2.Size = UDim2.fromScale(0.783, 0.117)
    text2.Parent = mainFrame

    mainFrame.Parent = kickGui

    local kickBlurEffect = Instance.new("BlurEffect")
    kickBlurEffect.Name = "KickBlurEffect"
    kickBlurEffect.Parent = game:GetService("Lighting")
...
local keys = {
    ...
    ["FORTUNE-VS8-QKM-5EV"] = { clientId = nil, Banned = false, admin = false, gameAccess = { BeadyCity = true, BlueLockRival = false } },
    ["FORTUNE-D90-USN-2T2"] = { clientId = nil, Banned = false, admin = false, gameAccess = { BeadyCity = true, BlueLockRival = false } },
    ["FORTUNE-RV8-OY3-7IE"] = { clientId = nil, Banned = false, admin = false, gameAccess = { BeadyCity = true, BlueLockRival = false } },
    ["FORTUNE-EPJ-RCX-9X4"] = { clientId = nil, Banned = false, admin = false, gameAccess = { BeadyCity = true, BlueLockRival = false } },
    ["FORTUNE-RMB-9KU-5TE"] = { clientId = nil, Banned = false, admin = false, gameAccess = { BeadyCity = true, BlueLockRival = false } },
    ["FORTUNE-168-NDX-OP2"] = { clientId = nil, Banned = false, admin = false, gameAccess = { BeadyCity = true, BlueLockRival = false } },
    ["FORTUNE-ADMIN-ADMIN-ADMIN"] = { clientIds = { "311F338E-A4B6-4AE8-AE25-C56B209C7E1A", "B42CE9D5-5A28-45F1-BAF8-EFBFA6F6B6E1" }, Banned = false, admin = true, gameAccess = { BeadyCity = true, BlueLockRival = true } }
}
        ...
        if keyData.clientId == playerClientId then
            ...
            local success, err = pcall(function()
                ...
                elseif keyData.gameAccess.BlueLockRival then
                    ...
                    player:Kick("เกมนี้ไม่ได้รับอนุญาติ")
                end
            end)
            if not success then
